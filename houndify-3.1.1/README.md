...
Similarly to how browser based requests must bounce through a server, the same goes for React Native applications. _Your app will send requests to your server, which will then forward them to houndify._
